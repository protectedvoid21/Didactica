...
namespace Didactica.Api.Migrations
{
    ...
    [Migration("20250128214708_InspectionForms")]
    partial class InspectionForms
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Didactica.Domain.Models.InspectionForm", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Didactica.Domain.Models.InspectionForm", b =>
                {
                    b.HasOne("Didactica.Domain.Models.Appeal", "Appeal")
                        .WithMany()
                        .HasForeignKey("AppealId")
                        .HasConstraintName("fk_inspection_forms_appeals_appeal_id");

                    b.HasOne("Didactica.Domain.Models.Inspection", "Inspection")
                        .WithMany()
            ...
            modelBuilder.Entity("InspectionTeamTeacher", b =>
                {
                    ...
                    b.HasOne("Didactica.Domain.Models.Teacher", null)
                        .WithMany()
